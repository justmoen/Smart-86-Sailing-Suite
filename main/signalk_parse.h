...
extern "C" {
  ...
  void set_vessel_nav_state(String& val) {
    if (val == "moored") {
      ...
      shipDataModel.navigation.state.age = esp_timer_get_time();
    } else if (val == "sailing") {
        ...
        if (starts_with(p, "navigation.")) {
          ...
          if (strcmp(t, "rateOfTurn") == 0) {
            if (value.is<float>()) {
              ...
              shipDataModel.navigation.rate_of_turn.age = esp_timer_get_time();
            }
          } else if (strcmp(t, "headingMagnetic") == 0) {
            if (value.is<float>()) {
              shipDataModel.navigation.heading_mag.deg = value.as<float>() * 180.0 / PI;
              shipDataModel.navigation.heading_mag.age = esp_timer_get_time();
            }
          ...
          //   }
            ...
            if (value.is<float>()) {
              ...
              shipDataModel.navigation.course_rhumbline.cross_track_error.age = esp_timer_get_time();
            }
            ...
            if (value.is<float>()) {
              ...
              shipDataModel.navigation.course_rhumbline.bearing_track_true.age = esp_timer_get_time();
            }
            ...
            if (value.is<float>()) {
              ...
              shipDataModel.navigation.course_rhumbline.next_point.distance.age = esp_timer_get_time();
            }
          ...
          //     shipDataModel.navigation.course_rhumbline.next_point.velocity_made_good.age = esp_timer_get_time();
          //   }
          ...
          if (starts_with(t, "wind.")) {
            ...
            if (strcmp(d, "belowKeel") == 0) {
              if (value.is<float>()) {
                ...
                shipDataModel.environment.depth.below_keel.age = esp_timer_get_time();
              }
            } else if (strcmp(d, "belowTransducer") == 0) {
              if (value.is<float>()) {
                shipDataModel.environment.depth.below_transducer.m = value.as<float>();
                shipDataModel.environment.depth.below_transducer.age = esp_timer_get_time();
              }
            } else if (strcmp(d, "belowSurface") == 0) {
              if (value.is<float>()) {
                shipDataModel.environment.depth.below_surface.m = value.as<float>();
                shipDataModel.environment.depth.below_surface.age = esp_timer_get_time();
              }
            }
          ...
          if (strcmp(t, "rudderAngle") == 0) {
            if (value.is<float>()) {
              ...
              shipDataModel.steering.rudder_angle.age = esp_timer_get_time();
            }
          }
